...
LadderManager::LadderManager(int InCoordinatorArgc, char **inCoordinatorArgv)
    ...
    : CoordinatorArgc(InCoordinatorArgc), CoordinatorArgv(inCoordinatorArgv), MaxEloDiff(0), ConfigFile("LadderManager.json"), EnableReplayUploads(false), EnableServerLogin(false), Config(nullptr)
{
}
...
LadderManager::LadderManager(int InCoordinatorArgc, char **inCoordinatorArgv, const char *InConfigFile)
    ...
    : CoordinatorArgc(InCoordinatorArgc), CoordinatorArgv(inCoordinatorArgv), MaxEloDiff(0), ConfigFile(InConfigFile), EnableReplayUploads(false), EnableServerLogin(false), Config(nullptr)
{
}
...
void LadderManager::RunLadderManager()
{
    ...
    PrintThread{} << "Initialization finished." << std::endl
                  << std::endl;
    Matchup NextMatch;
    try
    {
